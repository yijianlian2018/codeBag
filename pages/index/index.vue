	...
	<view class="page">
		<swiper class="banner" autoplay>
			<swiper-item v-for="(item, i) in banner" :key="i">
				<navigator v-if="item.url" :url="'video/video?src=' + item.url">
		...
		<view class="nav">
			<view @tap="navFilter" data-url="actList/actList" class="item bg">
				<image mode="widthFix" src="/static/daily.png"></image>
			</view>
			<view @tap="navFilter" data-url="articleList/articleList?title=企业文化&type=4" class="item bg">
				<image mode="widthFix" src="/static/qiye.png"></image>
			</view>
			<view @tap="navFilter" data-url="courseList/courseList" class="item bg">
		...
		<swiper class="swiper" autoplay>
			<swiper-item v-for="(item, i) in zizhi" :key="i">
				<image @tap="previewImage(i)" class="image" :src="item.img" mode="aspectFit"></image>
			</swiper-item>
		</swiper>
		<view class="title">
			<image src="/static/tuijian.png" mode=""></image>
		...
		<navigator class="buy" url="/pages/ucenter/servicer/servicer">
			<image src="../../static/buy.png" mode=""></image>
		</navigator>
	</view>
</template>
